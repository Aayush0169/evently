...
export default async function Home(props: PageProps<'/' >) {
  ...
  return (
    <>
    <section className="bg-primary-50 bg-dotted-patter bg-contain
      py-5 md:py-10">
        ...
        md:grid-cols-2 2xl:gap-0">
          ...
          <div className="flex flex-col justify-center gap-8">
            ...
            <Button size="lg" asChild className="button w-full sm:w-fit ml-1.0">
            <Link href="#events">
            Explore Now
            </Link>
            </Button>
          ...
          height={1000} width={1000} alt="hero-img"
